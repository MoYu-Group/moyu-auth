...
public class MoYuAuthenticationEntryPoint implements AuthenticationEntryPoint {
    ...
    public MoYuAuthenticationEntryPoint(MoYuAuthClientProperties moYuAuthClientProperties) {
        this.loginUrlAuthenticationEntryPoint = new MoyuLoginUrlAuthenticationEntryPoint(moYuAuthClientProperties);
